								...
								<section>
		                            ...
		                            <!--<p style="display: none; background: #eee; padding: 0.5cm " id="d_1_">
			                            ...
			                            <p style="display: none; background: #eee; padding: 0.5cm " id="r_1_">
			                                Solução:
			                                <br />
			                                (a) Suponha por absurdo que $x^{-1}\notin P$. Assim, temos que uma das duas possibilidas deve acontecer: $x^{-1}=0$ ou $-x^{-1}\in P$. Se $x^{-1}=0$ teríamos que $x\cdot x^{-1}=1\Rightarrow 0=1$, contradição. Se $-x^{-1}\in P$ e, por hipótese, $x\in P\Rightarrow x\cdot(-x^{-1})=-1\in P$, contradição.
			                                <br />
