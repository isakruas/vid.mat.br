								...
								<section>
		                            ...
		                            <!--<p style="display: none; background: #eee; padding: 0.5cm " id="d_1_">
			                            ...
			                            <p style="display: none; background: #eee; padding: 0.5cm " id="r_3_">
			                                ...
			                                \leq1$ e $\delta\leq\frac{\varepsilon}{5}$. Desta primeira condição, $|x-2|<5$ e, utilizando a segunda, temos $$|x^2-7-(-3)|=|x^2-4|=|x+2|\cdot|x-2|<\delta\cdot 5<\frac{varepsilon}{5}\cdot 5=\varepsilon=\varepsilon.$$
			                                <br /><br />
			                                (d) Rascunho: $\left| \frac{1}{x}-\frac{1}{3}\right|=\left| \frac{3-x}{3x}\right|=\left| \frac{|x-3|}{3|x|}\right|\;(*)$. Como $x$ tende a $3$, podemos supor que a distância de $x$ a $3$ é menor que $1$, ou seja, $|x-3|<1$. Logo, $3=|3|=|3-x+x|\leq |3-x|+|x|=|x-3|+|x|<1+|x|\Rightarrow |x|>2\Rightarrow \frac{1}{|x|}<\frac{1}{2}\;(**)$. Substituindo $(**)$ em $(*)$: $\left| \frac{1}{x}-\frac{1}{3}\right|=\left| \frac{|x-3|}{3|x|}\right|<\frac{|x-3|}{3\cdot 2}=\frac{|x-3|}{6}<\varepsilon\Rightarrow |x-3|<6\varepsilon\Rightarrow \delta=\min \left\{1,6\varepsilon \right\}.$
			                                <br />
			                                ...
			                                \leq1$ e $\delta\leq6\varepsilon$. Desta primeira condição, $|x|>2$ e, utilizando a segunda, temos $$\left| \frac{1}{x}-\frac{1}{3}\right|=\left| \frac{3-x}{3x}\right|=\left| \frac{|x-3|}{3|x|}\right|<\frac{6\varepsilon}{3\cdot2}=\varepsilon.$$
			                            </p>
